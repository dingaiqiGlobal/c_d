...
export default {
  ...
  methods: {
    ...
    addWFS() {
      //常规方式
      // this.viewer.dataSources.add(Cesium.GeoJsonDataSource.load('http://192.168.201.138:8090/geoserver/ZHJY/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ZHJY%3Abeijing&maxFeatures=500000&outputFormat=application%2Fjson', {
    ...
    addWMS() {
      let wms = new Cesium.WebMapServiceImageryProvider({
        url: "http://192.168.201.162:8088/geoserver/zhjy/ows",
        layers: "zhjy:polygon_beijing",
    ...
    addWMTS_GeoServer() {
      ...
      let geoWMTS = new Cesium.WebMapTileServiceImageryProvider({
        url: "http://192.168.201.138:8090/geoserver/gwc/service/wmts",
        layer: "ZHJY:haidian",
        style: "", //没有样式为空
