...
export default {
    ...
    mounted() {
        ...
        let geojson = new PrimitiveWaterFace(this.viewer, {
            ...
            geojsonUrl:'http://192.168.201.138:8090/geoserver/ZHJY/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ZHJY%3Axicheng&maxFeatures=50000&outputFormat=application%2Fjson',
