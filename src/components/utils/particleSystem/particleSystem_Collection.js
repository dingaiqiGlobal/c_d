...
//       //选择粒子放置的坐标
//       position: Cesium.Cartesian3.fromDegrees(116.830560, 40.371640),
//     });
//     this.init();
//   }
...
//         image: 'images/icon/particleSystem_fire.png',
...
export class FireEffect {
  constructor(viewer) {
    ...
    this.entity = this.viewer.entities.add({
      //选择粒子放置的坐标
      position: Cesium.Cartesian3.fromDegrees(116.830430, 40.371270),
    });
    this.init();
  }
...
export class WaterEffect {
  constructor(viewer) {
    ...
    this.entity = this.viewer.entities.add({
      //选择粒子放置的坐标
      position: Cesium.Cartesian3.fromDegrees(116.830840, 40.373490),
    });
    this.init();
  }
  ...
  init() {
    ...
    var particleSystem = this.scene.primitives.add(
      new Cesium.ParticleSystem({
        image: 'images/icon/particleSystem_water.png',//生成所需粒子的图片路径
        //粒子在生命周期开始时的颜色
...
export class ExplotEffect {
  constructor(viewer) {
    ...
    this.entity = this.viewer.entities.add({
      //选择粒子放置的坐标
      position: Cesium.Cartesian3.fromDegrees(116.830640, 40.368450),
    });
    this.init();
  }
  ...
  init() {
    ...
    var particleSystem = this.scene.primitives.add(
      new Cesium.ParticleSystem({
        image: 'images/icon/particleSystem_explot.png',//生成所需粒子的图片路径
        //粒子在生命周期开始时的颜色
...
export class SprayEffect {
  constructor(viewer) {
    ...
    this.entity = this.viewer.entities.add({
      //选择粒子放置的坐标
      position: Cesium.Cartesian3.fromDegrees(116.828630, 40.372110),
    });
    this.init();
  }
...
export class SmokeEffect {
  constructor(viewer) {
    ...
    this.entity = this.viewer.entities.add({
      //选择粒子放置的坐标
      position: Cesium.Cartesian3.fromDegrees(116.832650, 40.369030),
    });
    this.init();
  }
