...
class CoordTransform {
   ...
   * 经纬度=>笛卡尔3
   */
  static lonlat_cartesian3(lon, lat, height = 0) {
    let position = Cesium.Cartesian3.fromDegrees(lon, lat, height);
    return position;
  }
  static lonlat_cartesian3_2(viewer, lon, lat, height = 0) {
    let cartographic = Cesium.Cartographic.fromDegrees(lon, lat, height);
   ...
   * 笛卡尔3=>经纬度
   */
  static cartesian3_lonlat(position) {
  ...
  static cartesian3_lonlat_2(viewer, position) {
